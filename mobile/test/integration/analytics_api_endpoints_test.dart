...
void main() {
  group('Analytics API New Endpoints Integration Tests', () {
    ...
    group('Trending Videos Endpoint', () {
      test('GET /analytics/trending/vines - returns valid trending data',
          () async {
        final response = await http.get(
          Uri.parse('$baseUrl/analytics/trending/vines?window=24h&limit=10'),
          headers: {
        ...
        Log.info('✅ Trending videos endpoint: ${vines.length} videos returned');
      ...
      test('GET /analytics/trending/vines - respects limit parameter',
          () async {
      ...
      test('GET /analytics/trending/vines - performance check', () async {
        ...
        final response = await http.get(
          Uri.parse('$baseUrl/analytics/trending/vines?window=24h&limit=100'),
          headers: {
            'Accept': 'application/json',
            'User-Agent': userAgent,
          },
        ...
        expect(stopwatch.elapsedMilliseconds,
            lessThan(5000)); // Should be under 5s
    ...
    group('Trending Hashtags Endpoint', () {
      test('GET /analytics/trending/hashtags - returns valid hashtag data',
          () async {
        final response = await http.get(
          Uri.parse('$baseUrl/analytics/trending/hashtags?window=24h&limit=20'),
          headers: {
            'Accept': 'application/json',
            'User-Agent': userAgent,
          },
    ...
    group('Top Creators Endpoint', () {
      test('GET /analytics/trending/creators - returns valid creator data',
          () async {
        final response = await http.get(
          Uri.parse('$baseUrl/analytics/trending/creators?window=7d&limit=20'),
          headers: {
            'Accept': 'application/json',
            'User-Agent': userAgent,
          },
    ...
    group('Related Videos Endpoint', () {
      test('GET /analytics/vines/{id}/related - returns related videos',
          () async {
        ...
        final hashtagResponse = await http.get(
          Uri.parse(
        ...
        final cowatchResponse = await http.get(
          Uri.parse(
    ...
    group('Error Handling', () {
      ...
      test('handles excessive limit parameter', () async {
        final response = await http.get(
          Uri.parse('$baseUrl/analytics/trending/vines?window=24h&limit=10000'),
          headers: {
            'Accept': 'application/json',
            'User-Agent': userAgent,
          },
