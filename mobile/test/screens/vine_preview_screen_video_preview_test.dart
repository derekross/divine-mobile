...
void main() {
  group('VinePreviewScreenPure video preview', () {
    testWidgets('should show either VideoPlayer or placeholder after initialization', (tester) async {
      ...
      final hasPlaceholder = find.byIcon(Icons.play_circle_filled).evaluate().isNotEmpty;

      // One of these should be true
      expect(hasVideoPlayer || hasPlaceholder, isTrue,
        reason: 'Should show either VideoPlayer widget or placeholder icon after initialization');
    });

    testWidgets('should show VideoPlayer widget when video initializes successfully', (tester) async {
    ...
    testWidgets('should show placeholder when video fails to initialize', (tester) async {
