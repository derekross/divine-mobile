...
class MockNostrKeyManager extends _i1.Mock implements _i2.NostrKeyManager {
  ...
  @override
  _i6.Future<_i2.Keychain> generateKeys() => (super.noSuchMethod(
        Invocation.method(
          #generateKeys,
          [],
        ),
        returnValue: _i6.Future<_i2.Keychain>.value(_FakeKeychain_0(
          this,
          Invocation.method(
            #generateKeys,
            [],
  ...
  @override
  _i6.Future<List<String>> createMnemonicBackup() => (super.noSuchMethod(
        Invocation.method(
...
class MockEmbeddedNostrRelay extends _i1.Mock
  ...
  @override
  _i6.Stream<_i9.NostrEvent> get eventStream => (super.noSuchMethod(
  ...
  _i6.Future<_i3.Subscription> handleReq(
    ...
    _i11.ReqMessage? reqMessage,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i3.Subscription>.value(_FakeSubscription_1(
          this,
          Invocation.method(
            #handleReq,
            [
  ...
  @override
  _i6.Future<void> unsubscribe(String? subscriptionId) => (super.noSuchMethod(
        Invocation.method(
          #unsubscribe,
          [subscriptionId],
        ),
  ...
  @override
  _i6.Future<bool> publish(_i9.NostrEvent? event) => (super.noSuchMethod(
        Invocation.method(
          #publish,
          [event],
        ),
  ...
  @override
  _i6.Future<_i9.NostrEvent?> getEvent(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getEvent,
          [id],
        ),
  ...
  @override
  _i6.Future<void> deleteEvents(List<String>? eventIds) => (super.noSuchMethod(
        Invocation.method(
          #deleteEvents,
          [eventIds],
        ),
  ...
  @override
  _i4.RelayInfo getRelayInfo() => (super.noSuchMethod(
        Invocation.method(
          #getRelayInfo,
          [],
        ),
  ...
  @override
  _i6.Future<Map<String, int>> getStats() => (super.noSuchMethod(
        Invocation.method(
          #getStats,
          [],
        ),
  ...
  @override
  Map<String, dynamic> getSubscriptionStats() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.FunctionChannelSession createFunctionSession() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<void> addExternalRelay(String? url) => (super.noSuchMethod(
        Invocation.method(
          #addExternalRelay,
          [url],
        ),
  ...
  @override
  _i6.Future<void> removeExternalRelay(String? url) => (super.noSuchMethod(
        Invocation.method(
          #removeExternalRelay,
          [url],
        ),
