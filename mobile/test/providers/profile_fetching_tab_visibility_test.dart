...
void main() {
  group('Profile fetching with tab visibility', () {
    ...
    test('should NOT fetch profiles when Feed tab is active (index 0)',
        () async {
    ...
    test('should fetch profiles when any video tab is active', () async {
      ...
      expect(isFeedActive || isExploreActive || isProfileActive, isTrue,
          reason:
              'At least one video tab should be active for profile fetching');
    ...
    test('should NOT fetch profiles when camera tab is active (index 1)',
        () async {
