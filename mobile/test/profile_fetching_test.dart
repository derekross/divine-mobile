...
void main() {
  ...
  group('Profile Fetching on Video Display', () {
    test('should fetch profile when video is displayed without cached profile',
        () async {
      // Arrange
    ...
    test('should handle and cache profile when Kind 0 event is received',
        () async {
      // Arrange
      const testPubkey = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'; // Valid 64-char hex pubkey
      ...
      verify(mockCacheService.cacheProfile(argThat(
        predicate<UserProfile>((profile) =>
    ...
    test('should not fetch profile if already cached', () async {
      ...
      // Mock cached profile
      when(mockCacheService.getCachedProfile(testPubkey))
    ...
    test('should provide fallback display name when profile not available',
        () async {
      // Arrange
