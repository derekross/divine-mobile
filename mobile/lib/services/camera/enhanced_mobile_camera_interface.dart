...
class _EnhancedCameraPreviewState extends State<EnhancedCameraPreview> {
  ...
  Widget build(BuildContext context) {
    ...
    // This structure MUST match experimental app EXACTLY - CameraPreview directly in swapped SizedBox!
    return GestureDetector(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          // Camera preview with swapped dimensions - NO extra Stack wrapper!
          SizedBox.expand(
            child: FittedBox(
              fit: BoxFit.cover,
              child: SizedBox(
          ...
          // Focus indicator (outside swapped SizedBox so it's not scaled)
          if (_focusPoint != null)
            Positioned(
          ...
          // Zoom level indicator (outside swapped SizedBox so it's not scaled)
